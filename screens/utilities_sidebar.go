...
func NewUtilitiesSidebar(screen *MainScreen) *UtilitiesSidebar {
	...
	p.scanMem = button("utilityScanMemory", "MEM SNAP", 182, 298, 152, 31, func() {
...
func (p *UtilitiesSidebar) Draw() {
	...
	canEditGroup := memory.selectedGroup != "" && memory.selectedGroup != "ALL" && memory.selectedGroup != "UNGROUPED"
